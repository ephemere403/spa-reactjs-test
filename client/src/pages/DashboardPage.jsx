    ...
    return (<>
            ...
            <Container className="m-0">
                ...
                <Row className="p-0 pb-5">
                    <Col className="diagram col-12 col-md-6 col-xl-4 pb-5 " style={{maxHeight:"300px"}} > <SalesDiagram/> </Col>
                    <Col className="diagram col-12 col-md-6 col-xl-4  pb-5" style={{maxHeight:"300px"}}> <RequestDiagram/> </Col>
                    <Col className="diagram col-12 col-md-6 col-xl-4  pb-5" style={{maxHeight:"300px"}}> <KpiDiagram/> </Col>
                </Row>
